    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-background/80 flex flex-col items-center justify-center px-4">
      ...
      <div className="text-center mb-12 max-w-2xl">
        <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-4">
          Welcome to <span className="bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">RUMERA</span>
        </h1>
        <p className="text-lg text-foreground/70">
          Join us to verify content, detect hate speech, and identify deepfakes
        </p>
      </div>
