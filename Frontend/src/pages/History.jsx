...
export default function History() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      <Helmet>
        <title>Analysis History | RUMERA</title>
        <meta name="description" content="View your content verification history on RUMERA. Track past analyses of text, images, videos, and audio." />
      </Helmet>
