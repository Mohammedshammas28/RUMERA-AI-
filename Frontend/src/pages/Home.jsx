...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      <Helmet>
        <title>RUMERA — A New Era of Truth</title>
        <meta name="description" content="AI-powered platform for truth, trust, and safety. Detect misinformation, hate speech, deepfakes, and AI-generated content." />
      </Helmet>
