...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      <Helmet>
        <title>About RUMERA</title>
        <meta name="description" content="Learn about RUMERA's mission to combat misinformation using responsible AI. Discover our team, technology, and commitment to truth verification." />
      </Helmet>
