...
export default function Analyze() {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Analyze Content | RUMERA</title>
        <meta name="description" content="Verify text, images, videos, and audio for misinformation, hate speech, deepfakes, and AI-generated content using RUMERA's advanced AI analysis tools." />
      </Helmet>
